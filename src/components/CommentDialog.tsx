...
function CommentDialog({ interviewId }: { interviewId: Id<"interviews"> }) {
  ...
  const handleSubmit = async () => {
    if (!comment.trim()) return toast.error("Пожалуйста, введите комментарий");
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>Комментарий к интервью</DialogTitle>
        </DialogHeader>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">
                                {format(comment._creationTime, "d MMM yyyy • HH:mm", {
                                  locale: ru,
                                })}
                              </p>
                            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Напишите подробный отзыв об интервью..."
                className="h-32"
              />
            </div>
          </div>
